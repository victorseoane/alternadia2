...
describe("createUser function ",()=>{
    ...
    it("works for simple case",()=>{
        const user = createUser(nameTest,firstNameTest,emailTest,phoneTest)
        const expectedUser = {name:nameTest,firstName:firstNameTest,email:emailTest,phone:phoneTest,activityList:[]}
...
describe("addActivity function ",()=>{
    ...
    it("works for simple case",()=>{
        ...
        const expectedUser = {name:"Victor",firstName:"Seoane",email:"victors@alternaenergetica.com",phone:"605968538",activityList:[{name:"Work meeting",date:"23/07/2020",hour:"11:30"}]}
